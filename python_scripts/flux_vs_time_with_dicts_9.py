...
# here, you open the ascii file
	...
	np.savetxt(datafile_id, data_wei_o, fmt=['%s','%s','%s','%d'], delimiter='\t\t', header='Time (MJD), Flux, Flux Error (microjanskys)', footer='\n')
	np.savetxt(datafile_id, data_wei_c, fmt=['%s','%s','%s','%d'], delimiter='\t\t', header='Time (MJD), Flux, Flux Error (microjanskys)', footer='\n')
...
#plt.errorbar(time_array_o, measurement_array_o, yerr=uncertainty_array_o, fmt='o', color='orange', alpha = 0.2, capsize=5)
#plt.errorbar(time_array_c, measurement_array_c, yerr=uncertainty_array_c, fmt='o', color='cyan', alpha = 0.2, capsize=5)
