...
data = np.genfromtxt("k9B7deoy.txt", delimiter=',', dtype = float)	


# Now, to read the data file to determine the type of filters used, and write them as single-letter strings ('o' for 'orange filter' and 'c' for 'cyan filter') to a list called 'filters'
filters = 
