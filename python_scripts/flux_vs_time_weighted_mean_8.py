...
# Now to calculate the mean values of flux and time
...
plt.errorbar(time_mean_o, flux_weighted_mean_o, yerr=flux_weighted_mean_err_o, fmt='o', color='orange', capsize=5)
plt.errorbar(time_mean_c, flux_weighted_mean_c, yerr=flux_weighted_mean_err_c, fmt='o', color='blue', capsize=5)

plt.plot(time_mean_o, flux_mean_o, 'o', color='magenta')
plt.plot(time_mean_c, flux_mean_c, 'o', color='green')

plt.errorbar(time_o, flux_o, yerr = dflux_o, fmt='o', color='red', alpha = 0.1, capsize=5)
plt.errorbar(time_c, flux_c, yerr = dflux_c, fmt='o', color='cyan', alpha = 0.1, capsize=5)
...
plt.savefig('flux_vs_time_mean_plot_normal_and-weighted.pdf')
