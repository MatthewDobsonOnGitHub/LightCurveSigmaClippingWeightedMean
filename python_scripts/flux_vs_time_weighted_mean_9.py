...
plt.errorbar(time_mean_o, flux_weighted_mean_o, yerr=flux_weighted_mean_err_o, fmt='o', color='red', capsize=5)
...
plt.errorbar(time_o, flux_o, yerr = dflux_o, fmt='o', color='orange', alpha = 0.1, capsize=5)
...
plt.savefig('flux_vs_time_mean_plot_weighted_and_errors.pdf')
