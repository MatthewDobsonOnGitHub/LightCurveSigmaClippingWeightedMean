...
def general_code1(filename, telescope, firstLine):
	...
	for row in reader:
		...
		row["MAGZPT"] = row["MAGZPT"]
		row["MAG5SIG"] = row["MAG5SIG"]
		row["AIRMASS"] = row["AIRMASS"]
		row["SEEING"] = row["SEEING"]
		row["SKYMAG"] = row["SKYMAG"]
		row["CLOUD"] = row["CLOUD"]
		row["MOONSKY"] = row["MOONSKY"]
		row["MANGLE"] = row["MANGLE"]
