...
mean_data_o["Uncertainty"] = s_dev_o
...
mean_data_c["Uncertainty"] = s_dev_c
...
#data_wei_o = np.array([mean_data_o["Time"], mean_data_o["Flux"], mean_data_o["Error"])
#data_wei_c = np.array([mean_data_c["Time"], mean_data_c["Flux"], mean_data_c["Error"])
...
fig_name = supernova + '_flux_vs_time_raw_and_weighted_mean_dict.pdf'
