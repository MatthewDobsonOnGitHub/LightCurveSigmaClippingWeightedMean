...
######### MEDIAN AND STANDARD DEVIATION FUNCTION - ALTERNATE ###########
def median_and_stdev_alt(value):	
...
####### WEIGHTED MEAN FUNCTION - ALTERNATE #######
def weighted_mean_function_alt(dictionary):	
...
####### CLIPPING FUNCTION - ALTERNATE ########	
	
def clipping_function_alt(input_dictionary, output_dictionary):
	...
	for key, value in input_dictionary.items():
		...
		# Finding the standard deviation and median values for each day; the function returns two variables, and assigns the values in a specific order, so be careful!
		sigma, med = median_and_stdev_alt(value)
		...
		while(True): # Infinite loop, until the last two elements in the array are of equal length
			...
			sigma, med = median_and_stdev_alt(new_list)
...
clipping_data_o_hawaii = odict_hawaii.copy()
clipping_data_c_hawaii = cdict_hawaii.copy()
...
clipped_data_o_hawaii = {}
clipped_data_c_hawaii = {}

clipped_data_o_hawaii = clipping_function_alt(clipping_data_o_hawaii, clipped_data_o_hawaii)
clipped_data_c_hawaii = clipping_function_alt(clipping_data_c_hawaii, clipped_data_c_hawaii)
...
clipped_mean_data_o_hawaii = {}
clipped_mean_data_c_hawaii = {}
clipped_raw_data_o_hawaii = {}
clipped_raw_data_c_hawaii = {}
...
# ORANGE ALTERNATE #
raw_data_o_hawaii["Time"], raw_data_o_hawaii["Flux"], raw_data_o_hawaii["STDEV"], mean_data_o_hawaii["Time"], mean_data_o_hawaii["Flux"], mean_data_o_hawaii["STDEV"],  mean_data_o_hawaii["Number"], mean_data_o_hawaii["Error"] = weighted_mean_function_alt(clipping_data_o_hawaii)

clipped_raw_data_o_hawaii["Time"], clipped_raw_data_o_hawaii["Flux"], clipped_raw_data_o_hawaii["STDEV"], clipped_mean_data_o_hawaii["Time"], clipped_mean_data_o_hawaii["Flux"], clipped_mean_data_o_hawaii["STDEV"],  clipped_mean_data_o_hawaii["Number"], clipped_mean_data_o_hawaii["Error"] = weighted_mean_function_alt(clipped_data_o_hawaii)


# CYAN ALTERNATE #
raw_data_c_hawaii["Time"], raw_data_c_hawaii["Flux"], raw_data_c_hawaii["STDEV"], mean_data_c_hawaii["Time"], mean_data_c_hawaii["Flux"], mean_data_c_hawaii["STDEV"],  mean_data_c_hawaii["Number"], mean_data_c_hawaii["Error"] = weighted_mean_function_alt(clipping_data_c_hawaii)

clipped_raw_data_c_hawaii["Time"], clipped_raw_data_c_hawaii["Flux"], clipped_raw_data_c_hawaii["STDEV"], clipped_mean_data_c_hawaii["Time"], clipped_mean_data_c_hawaii["Flux"], clipped_mean_data_c_hawaii["STDEV"],  clipped_mean_data_c_hawaii["Number"], clipped_mean_data_c_hawaii["Error"] = weighted_mean_function_alt(clipped_data_c_hawaii)
...
# here, you open the ascii file
	...
	np.savetxt(datafile_id, data_raw_o_hawaii, fmt=['%s','%s','%s'], delimiter='\t\t', header='Time (MJD), Flux and Flux Error (microjanskys) for Orange Filter (Raw data) (HAWAII)',footer='\n\n\n')
	np.savetxt(datafile_id, data_raw_c_hawaii, fmt=['%s','%s','%s'], delimiter='\t\t', header='Time (MJD), Flux and Flux Error (microjanskys) for Cyan Filter (Raw data) (HAWAII)',footer='\n\n\n')
	np.savetxt(datafile_id, data_wei_o_hawaii, fmt=['%s','%s','%s','%s'], delimiter='\t\t', header='Time (MJD), Flux, Flux Error (microjanskys) and No. Measurements per Weighted Mean for Orange Filter (Weighted Averages) (HAWAII)', footer='\n\n\n')
	np.savetxt(datafile_id, data_wei_c_hawaii, fmt=['%s','%s','%s','%s'], delimiter='\t\t', header='Time (MJD), Flux, Flux Error (microjanskys) and No. Measurements per Weighted Mean for Cyan Filter (Weighted Averages) (HAWAII)', footer='\n\n\n')
...
plt.errorbar(raw_data_o["Time"], raw_data_o["Flux"], yerr=raw_data_o["Error"], fmt='o', color='orange', alpha = 0.8, capsize=5)
plt.errorbar(raw_data_c["Time"], raw_data_c["Flux"], yerr=raw_data_c["Error"], fmt='o', color='cyan', alpha = 0.8, capsize=5)
