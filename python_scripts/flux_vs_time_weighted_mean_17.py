...
# and write the data plotted to a .txt file

filename = 'SN2019ehf_flux_data.txt'

original = sys.stdout

filecontent = [time_o, flux_o, dflux_o, time_c, flux_c, dflux_c, time_mean_o, flux_weighted_mean_o, stdev_o, time_mean_o, flux_weighted_mean_o, stdev_o]
