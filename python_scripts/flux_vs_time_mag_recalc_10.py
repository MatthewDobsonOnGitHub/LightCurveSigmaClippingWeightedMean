...
filename_2 = supernova + '_flux_weighted_mean_and_mag_no_mag_error.txt'
...
# here, you open the ascii file
	...
	np.savetxt(datafile_id, data_mag_o, fmt=['%s','%s','%s'], delimiter='\t\t', header='Time (MJD), Flux (microjanskys) and Calculated Magnitude Value for Orange Filter (Raw data)',footer='\n\n\n')
	np.savetxt(datafile_id, data_mag_c, fmt=['%s','%s','%s'], delimiter='\t\t', header='Time (MJD), Flux (microjanskys) and Calculated Magnitude Value for Cyan Filter (Raw data)',footer='\n\n\n')
