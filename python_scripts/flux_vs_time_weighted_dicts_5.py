...
for key, value in odict.items():
	...
	print()
	print("StDev Associated with Weighted Mean - Orange")
	print(stdv_o)
	...
	print(weighted_standard_deviation_o)
...
for key, value in cdict.items():
	...
	print()
	print("StDev Associated with Weighted Mean - Cyan")
	print(stdv_c)
	...
	print(weighted_standard_deviation_c)
