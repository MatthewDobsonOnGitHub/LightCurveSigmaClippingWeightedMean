...
filename = 'SN2019ehf_flux_data.txt'


zip(time_o, flux_o, dflux_o, time_c, flux_c, dflux_c, time_mean_o, flux_weighted_mean_o, stdev_o, time_mean_o, flux_weighted_mean_o, stdev_o)


with open(filename, 'w') as f:

	writer = csv.writer(f, delimiter = '\t')
	writer.writerows(zip(time_o, flux_o, dflux_o, time_c, flux_c, dflux_c, time_mean_o, flux_weighted_mean_o, stdev_o, time_mean_o, flux_weighted_mean_o, stdev_o))
...
plt.savefig('flux_vs_time_mean_plot_stdev_and_errors_17.pdf')
