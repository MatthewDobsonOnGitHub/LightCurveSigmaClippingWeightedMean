...
for key, value in odict.items():
	...
	for row in value:
		...
		raw_data_o["Time"] = value[row]["mjd"]
		raw_data_o["Flux"] = value[row]["calc_flux"]
		raw_data_o["Error"] = value[row]["calc_dflux"]
...
for key, value in cdict.items():
	...
	for row in value:
		...
		raw_data_c["Time"] = value[row]["mjd"]
		raw_data_c["Flux"] = value[row]["calc_flux"]
		raw_data_c["Error"] = value[row]["calc_dflux"]
...
print("Raw Data - Orange")
print(raw_data_o)
print()
print("Raw Data - Cyan")
print(raw_data_c)
print()
print("Mean Data - Orange")
print(mean_data_o)
print()
print("Mean Data - Cyan")
print(mean_data_c)
print()
...
# Since we don't know how many magnitude values will be sifted and calculated without looking at the raw data file, we define arrays that will contain intermediate calculated quantities as empty, and append values to them.
