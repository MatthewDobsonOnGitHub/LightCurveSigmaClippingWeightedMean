...
for key, value in odict_hawaii.items():
	...
	for row in value:
		...
		print(row["mjd"], row["calc_flux"], row["calc_dflux"], row["weight"])   
		time_sum_o_hawaii = time_sum_o_hawaii + float(row["mjd"])   
		flux_weight_product_sum_o_hawaii = flux_weight_product_sum_o_hawaii + (float(row["calc_flux"])*float(row["weight"]))
		weight_sum_o_hawaii = weight_sum_o_hawaii + float(row["weight"])         
		measurement_array_o_hawaii.append(row["calc_flux"]) 
		uncertainty_array_o_hawaii.append(row["calc_dflux"]) 
		time_array_o_hawaii.append(row["mjd"]) 

		r_flux_o_hawaii.append(float(row["calc_flux"])) 
		r_dev_o_hawaii.append(float(row["calc_dflux"])) 
	...
	print()
	print("Weighted Sum - Cyan")
	print(weighted_flux_o_hawaii)
	w_flux_o_hawaii.append(weighted_flux_o_hawaii)
	print()
	print("Uncertainty Associated with Weighted Mean - Orange")
	print(stdv_o_hawaii)
	s_dev_o.append(stdv_o_hawaii)
	print()
	print("Number of Data Points Averaged in this Day - Orange")
	print(len(value))
...
for key, value in cdict_hawaii.items():
	...
	for row in value:
		...
		print(row["mjd"], row["calc_flux"], row["calc_dflux"], row["weight"])   
		time_sum_c_hawaii = time_sum_c_hawaii + float(row["mjd"])   
		flux_weight_product_sum_c_hawaii = flux_weight_product_sum_c_hawaii + (float(row["calc_flux"])*float(row["weight"]))
		weight_sum_c_hawaii = weight_sum_c_hawaii + float(row["weight"])         
		measurement_array_c_hawaii.append(row["calc_flux"]) 
		uncertainty_array_c_hawaii.append(row["calc_dflux"]) 
		time_array_c_hawaii.append(row["mjd"]) 

		r_flux_c_hawaii.append(float(row["calc_flux"])) 
		r_dev_c_hawaii.append(float(row["calc_dflux"])) 
...
print()
print("Raw Times - Orange")
print(raw_data_o_hawaii["Time"])
print()
print("Flux Times - Orange")
print(raw_data_o_hawaii["Flux"])
print()
print("Error Times - Orange")
print(raw_data_o_hawaii["Error"])
print()
print("Raw Times - Cyan")
print(raw_data_c_hawaii["Time"])
print()
print("Flux Times - Cyan")
print(raw_data_c_hawaii["Flux"])
print()
print("Error Times - Cyan")
print(raw_data_c_hawaii["Error"])
print()
