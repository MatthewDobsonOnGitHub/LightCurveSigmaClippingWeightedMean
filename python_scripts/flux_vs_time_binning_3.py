...
for array_element in flux_binned_o:

	print()
	print("Orange Element Array")
	print(array_element)
	med_o = stat.median(array_element)
	stdv_o = np.std(array_element)
	print("Median of Element Array")
	print(med_o)
	print("Sigma of Element Array")
	print(stdv_o)


for array_element in flux_binned_c:
	
	print()
	print("Cyan Element Array")
	print(array_element)
	med_c = stat.median(array_element)
	stdv_c = np.std(array_element)
	print("Median of Element Array")
	print(med_c)
	print("Sigma of Element Array")
	print(stdv_c)
