...
print("Raw Times - Orange")print(r_time_o)print()
print("Flux Times - Orange")print(r_flux_o)print()
print("Error Times - Orange")print(r_dev_o)print()
print("Raw Times - Cyan")print(r_time_c)print()
print("Flux Times - Cyan")print(r_flux_c)print()
print("Error Times - Cyan")print(r_dev_c)print()
...
data_raw_o = np.array([r_time_o, r_flux_o, r_dev_o])
data_raw_c = np.array([r_time_c, r_flux_c, r_dev_c])
