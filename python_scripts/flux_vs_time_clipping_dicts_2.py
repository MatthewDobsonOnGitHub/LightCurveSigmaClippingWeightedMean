...
clipping_data_o = odict
clipping_data_c = cdict
...
for key, value in clipping_data_o.items():
	...
	# while at least one of the rows in a key:value pair is beyond 1sigma from mean:

		# print the key of the data dictionary (i.e. the integer day)
		print()
		print("Day MJD")
		print(key)
		...
		# (For every measurement in a day)
		for row in value:
