...
def remove_row(value, sigma, median):
	...
	for row in value:
		...
		if row["calc_flux"] < (median + sigma) and row["calc_flux"] > (median - sigma):
...
print(len(mean_data_o["Time"]))
print("Length of Flux")
print(len(mean_data_o["Flux"]))
print("Length of Error")
print(len(mean_data_o["Error"]))
print(mean_data_o["Error"])
...
print("Length of Time")
print(len(mean_data_c["Time"]))
print("Length of Flux")
print(len(mean_data_c["Flux"]))
print("Length of Error")
print(len(mean_data_c["Error"]))
print(mean_data_c["Error"])
...
data_wei_o = np.array([mean_data_o["Time"], mean_data_o["Flux"], mean_data_o["STDEV"], mean_data_o["Number"]])
data_wei_c = np.array([mean_data_c["Time"], mean_data_c["Flux"], mean_data_c["STDEV"], mean_data_c["Number"]])
...
plt.errorbar(mean_data_o["Time"], mean_data_o["Flux"], yerr=mean_data_o["STDEV"], fmt='o', color='red', capsize=5)
plt.errorbar(mean_data_c["Time"], mean_data_c["Flux"], yerr=mean_data_c["STDEV"], fmt='o', color='blue', capsize=5)
