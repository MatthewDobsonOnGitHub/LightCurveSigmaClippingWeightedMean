...
# each row in the datafile becomes its own row; 'reader' contains many dictionaries.
...
#for wholeMJD, entireRow in odict.items():
#    print (wholeMJD)     
#    for member in entireRow:
#        print(member)
...
# The key of each dictionary is the integer date at which it occured at

    print (key)

    for row in value:

        print(row["mjd"], row["calc_flux"], row["calc_dflux"])
