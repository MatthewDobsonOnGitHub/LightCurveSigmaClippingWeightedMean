...
for key, value in odict.items():
	...
	for row in value:
		...
		raw_data_o["Flux"] = float(row["calc_flux"])
		raw_data_o["Error"] = float(row["calc_dflux"])
		raw_data_o["Time"] = float(row["mjd"])
		#raw_data_o["Magnitude"] = (row["mag"])
...
for key, value in cdict.items():
	...
	for row in value:
		...
		raw_data_c["Flux"] = float(row["calc_flux"])
		raw_data_c["Error"] = float(row["calc_dflux"])
		raw_data_c["Time"] = float(row["mjd"])
		#raw_data_c["Magnitude"] = (row["mag"])
...
print()
print("Measured magnitudes - orange")
print(len(magnitude_raw_o))
print()
print("Re-calculated magnitudes - orange")
print(len(magnitude_recalc_o))
print()
print("Measured magnitudes - cyan")
print(len(magnitude_raw_c))
print()
print("Re-calculated magnitudes - cyan")
