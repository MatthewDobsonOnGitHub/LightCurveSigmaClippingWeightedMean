...
# WARNING!!!! AS OF THU 25TH JULY, THE FOLLOWING CODE CLIPS OFF THE LAST DATA PAIR FOR EACH LENS FILTER.

# THIS PROBLEM IS NOT YET RECTIFIED!!!!!
...
time_divisor_o = 0	# How many time values are being averaged in a given day for the orange filter
time_divisor_c = 0	# How many time values are being averaged in a given day for the cyan filter

flux_divisor_o = 0	# How many time values are being averaged in a given day for the orange filter
flux_divisor_c = 0	# How many time values are being averaged in a given day for the cyan filter
...
for i in range(0, len(dates_o)):
	...
	for j in range(counter_o, len(time_o)):
		...
		if math.floor(time_o[j]) == dates_o[i]:
			...
			time_sum_o = time_sum_o + time_o[j]

			# Sum of all flux values (unweighted)
			flux_sum_o = flux_sum_o + flux_o[j]

			# Keeps count of number of time values that have been summed thus far
			time_divisor_o = time_divisor_o + 1

			# Keeps count of number of flux values that have been summed thus far
			flux_divisor_o = flux_divisor_o + 1

			# Keeps count of items in flux and time arrays that have been analysed
			counter_o = counter_o + 1

		elif math.floor(time_o[j]) != dates_o[i]:	# This condition is when we have reached 									a measured time which occured the 									succeeding day.
			...
			if flux_divisor_o == 0 or time_divisor_o == 0:

				flux_divisor_o = 1
				time_divisor_o = 1

			# When we've reached the end of a day, we calculate the mean time... 
			mean_time_calculated = time_sum_o / time_divisor_o


			# ...and the mean flux...
			mean_flux_calculated = flux_sum_o / flux_divisor_o


			# ...and append them to the appropriate arrays.
			time_mean_o.append(mean_time_calculated)
			flux_mean_o.append(mean_flux_calculated)	
...
#print(time_o)
#print()
#print("Orange Mean Times:")
#print(time_mean_o)
#print()
#print("Orange Fluxes:")
#print(flux_o)
#print()
#print("Orange Mean Fluxes:")
#print(flux_mean_o)
#print()
#print()
#print()
...
#print(time_c)
#print()
#print("Cyan Mean Times:")
#print(time_mean_c)
#print()
#print("Cyan Fluxes:")
#print(flux_c)
#print()
#print("Cyan Mean Fluxes:")
#print(flux_mean_c)
print()
...
#plt.plot(time_o, flux_o, 'o', color='red', alpha = 0.2)
plt.plot(time_c, flux_c, 'ob', alpha = 0.2)
