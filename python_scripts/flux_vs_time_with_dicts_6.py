...
mean_data_o = {}	# The averaged data (time, flux, et al) go in these arrays, separated by filter
mean_data_c = {}
...
print()
m_time_o = []	# Mean time
w_flux_o = []	# Weighted mean flux
s_dev_o = []	# Standard Deviation of Weighted Mean
print()
...
fig_name = supernova + '_flux_vs_time_raw_and_weighted_mean_dict_manual_sigma.pdf'
