...
raw_data_o["Three_Sigma"] = [3*x for x in r_dev_o]
...
raw_data_c["Three_Sigma"] = [3*x for x in r_dev_c]
...
filename_2 = supernova + '_flux_weighted_mean_three_sigma.txt'

data_raw_o = np.array([raw_data_o["Time"], raw_data_o["Flux"], raw_data_o["Error"], raw_data_o["Three_Sigma"]])
data_raw_c = np.array([raw_data_c["Time"], raw_data_c["Flux"], raw_data_c["Error"], raw_data_c["Three_Sigma"]])
...
# here, you open the ascii file
	...
	np.savetxt(datafile_id, data_raw_o, fmt=['%s','%s','%s','%s'], delimiter='\t\t', header='Orange Filter \n Time (MJD) \t\t Flux (microJy) \t\t Flux Error (microJy) \t\t 3-sigma error',footer='\n\n\n')
	np.savetxt(datafile_id, data_raw_c, fmt=['%s','%s','%s','%s'], delimiter='\t\t', header='Cyan Filter \n Time (MJD) \t\t Flux (microJy) \t\t Flux Error (microJy) \t\t 3-sigma error',footer='\n\n\n')
	np.savetxt(datafile_id, data_wei_o, fmt=['%s','%s','%s','%d'], delimiter='\t\t', header='Orange Filter \n Mean Time (MJD) \t\t Weighted Flux (microJy) \t Flux Error (microJy) \t No. Measurements per Weighted Mean', footer='\n\n\n')
	np.savetxt(datafile_id, data_wei_c, fmt=['%s','%s','%s','%d'], delimiter='\t\t', header='Cyan Filter \n Mean Time (MJD) \t\t Weighted Flux (microJy) \t Flux Error (microJy) \t No. Measurements per Weighted Mean', footer='\n\n\n')
...
fig_name = supernova + '_flux_vs_time_plot_three_sigma.pdf'
