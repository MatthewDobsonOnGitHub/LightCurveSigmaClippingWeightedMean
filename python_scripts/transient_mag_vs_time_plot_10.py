...
# The equal to zero condition uses zero to several decimal places, to distinguish potentially near-zero magnitude measurement values from upper limits.
...
for i in range(0, len(mag_mean)):
	if math.isnan(mag_mean[i]) != True and mag_mean[i] != 0.0000000:
...
plt.savefig('mag_vs_time_plot_10.pdf')
