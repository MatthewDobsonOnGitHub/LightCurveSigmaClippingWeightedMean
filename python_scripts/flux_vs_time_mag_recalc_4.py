...
# For SN2018kzr, we have data from anothet source which warrants comparison to ours. In the epoch from MJD 58475 and 58599, we need to calculate the magnitudes of the observations using the flux values we have. 

# For various non-observations, we need to multiply the uncertainty in magnitude by 3, to find the 3-sigma uncertainty. 
